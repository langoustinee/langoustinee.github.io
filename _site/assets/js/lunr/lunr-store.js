var store = [{
        ...
        "excerpt":"     문제 풀이     이번 문제는 너비 우선 탐색인 BFS를 이용해 풀 수 있는 문제이다.       아이디어 도출   이번 문제는 BFS를 이용한 기초 문제 중 하나이다.       문제 풀이를 위해 작성한 코드는 아래와 같다.   작성코드     1    출처        해당 문제의 저작권은 문제를 만든이에게 있으며 자세한 내용은 문제 링크에서 참조바랍니다.  ","categories": ["Java"],
        "tags": ["blog","algorithm","study","java","baekjoon"],
        "url": "/java/276-post/",
        "teaser": null
      }]
