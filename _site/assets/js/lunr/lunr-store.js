var store = [{
        ...
        "excerpt":"문제 풀이 이번 문제는 동적 계획법 DP를 이용해 풀 수 있는 문제이다. 아이디어 도출 필자는 반복문을 활용한 Bottom-Up 방식이 아닌 재귀 함수를 이용한 Top-Down 방식을 이용해 풀었다. 이번 문제는 이전에 풀었던 계단 오르기와 같은 LIS(최장 증가 부분 수열) 유형의 문제이다. 최장 증가 부분 수열(LIS)란 주어진 수열에서 오름차순으로 구성 가능한 원소들을...","categories": ["Java"],
        "tags": ["blog","algorithm","study","java","baekjoon"],
        "url": "/java/268-post/",
        "teaser": null
      }]
