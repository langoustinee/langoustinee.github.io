var store = [{
        ...
        "excerpt":"문제 풀이 문제 풀이에 앞서 이항 계수가 무엇인지 알아보자. 이항계수란? 위키백과를 보면 조합론에서 이항 계수(inomial coefficient)는 이항식을 이항 정리로 전개했을 때 각 항의 계수이며, 주어진 크기의 (순서 없는) 조합의 가짓수라고 한다. 전체 집합에서 원소개의 개수 n에 대해 k개의 아이템을 뽑는 이항계수(조합의 수)는 다음과 같다. 단순하게 위 공식을 이용하면 5개의 집합...","categories": ["Java"],
        "tags": ["blog","algorithm","study","java","baekjoon"],
        "url": "/java/139-post/",
        "teaser": null
      }]
